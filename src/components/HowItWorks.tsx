    ...
    <section className="py-16 px-4 bg-card border-y border-border">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 text-foreground">How It Works — Fast, Local Gravel Delivery in 3 Simple Steps</h2>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <Card key={index} className="border border-border shadow-sm transition-all hover:shadow-md bg-card">
              <CardHeader className="pb-2 flex flex-col items-center">
                ...
                <CardTitle className="text-xl font-bold text-foreground">Step {index + 1}: {step.title}</CardTitle>
              </CardHeader>
