...
import { Plus, Minus, Package, Layers, Mountain, RockingChair, Building2, Shovel, Waves, Flower, Scale } from 'lucide-react';
  ...
  return <div className="py-8 md:py-16 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-6 md:mb-8">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 mx-0">Quick Price Compare <Scale className="h-8 w-8" /></h2>
