...
import { FileText, HelpCircle, Blog, Truck, Users, Mail, ShoppingCart, Calculator, Plan, Star, Quote } from 'lucide-react';
...
const Footer = () => {
  ...
  const navLinks = [
    ...
    { label: 'Plan Project', href: '/quiz', icon: <Plan className="h-4 w-4" /> },
