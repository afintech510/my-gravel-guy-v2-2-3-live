...
const DepositOption = ({
  ...
  return <div className="bg-gradient-to-r from-primary/5 to-primary/10 border border-primary/20 rounded-lg p-6 mb-4">
              ...
              <div className="border-t pt-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="flex items-center gap-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <div>
                      <div className="text-xs font-medium text-blue-800">Expected Card Price</div>
                  ...
                  <div className="flex items-center gap-2 p-3 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <div>
                      <div className="text-xs font-medium text-green-800">Expected Cash Price</div>
