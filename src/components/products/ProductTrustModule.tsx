...
const ProductTrustModule = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 py-4 px-4 bg-gray-50 rounded-lg border">
      ...
      <div className="flex items-center justify-center gap-2">
        ...
        <span className="text-sm font-medium text-gray-700 text-center">Premium Quality Guaranteed</span>
      </div>
